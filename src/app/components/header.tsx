    ...
    <>
      <header className={styles.header}>
        <nav className={styles.nav} id="navbar">
          {!menu ?
            <Image onClick={menuclick} className={styles.menuicon} src="/menu.png" width={40} height={40} alt="menu" />
            :
            <Image onClick={menuclick} className={styles.menuicon} src="/menu2.png" width={40} height={40} alt="menu" />
          }
          <div className={styles.inputContainer}>
            ...
            />
            <Image src="/input/search.png" className={styles.searchIcon} width={20} height={20} alt="search" onClick={(e) => handleClick(e)} />
          </div>
          {/* <label className={styles.switch}>
            ...
            <input onClick={modefunction} type="checkbox" className={styles.input} />
            <span className={styles.slider}></span>
          </label> */}
          <Link href="/home" style={{ textDecoration: "none", color: "black" }}>
            <h1>VLOG</h1>
          </Link>
        </nav>
        {menuBar ?
          <div className={styles.menuitems}>
            <Link href="/home" style={{ textDecoration: "none", color: "black" }} onClick={(() => {
              setMenuBar(false);
              setmenu(false);
            })}>
            ...
            <Link href="/about" style={{ textDecoration: "none", color: "black" }} onClick={(() => {
              setMenuBar(false);
              setmenu(false);
            })}>
            ...
            <Link href="/contact" style={{ textDecoration: "none", color: "black" }} onClick={(() => {
              setMenuBar(false);
              setmenu(false);
            })}>
